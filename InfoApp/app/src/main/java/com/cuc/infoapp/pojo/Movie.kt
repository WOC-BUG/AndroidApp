...
class Movie(val error_code :Int,val reason :String,val movieid :String,val actors :String,val also_known_as:String,val country:String,val directors:String,
            val film_locations:String, val generes:String,val language:String,val plot_simple:String,val poster:String,val rated:String,val rating :String,
            val rating_count:String,val release_date:String,val runtime:String,val title:String,val type:String,val writers:String,val year:Int) {
    fun getCover(): String {
TODO("不知道该干啥")
    }
